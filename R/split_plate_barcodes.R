...
initial_files1 = rep(pair1_filepath, length(forward_barcode))
initial_files2 = rep(pair2_filepath, length(forward_barcode))

split_plate_barcodes = data.frame(initial_files1,
                                  initial_files2,
                                  forward_barcode,
